...
class MarkdownToWordConverter:
    ...
    def replace_placeholders(self, doc, company_name):
        ...
        for paragraph in doc.paragraphs:
            if '{{section1_title}}' in paragraph.text or '{{section1_content}}' in paragraph.text or \
                    '{{section2_title}}' in paragraph.text or '{{section2_content}}' in paragraph.text or \
                    '{{section3_title}}' in paragraph.text or '{{section3_content}}' in paragraph.text or \
                    '{{section4_title}}' in paragraph.text or '{{section4_content}}' in paragraph.text or \
                    '{{section5_title}}' in paragraph.text or '{{section5_content}}' in paragraph.text:
