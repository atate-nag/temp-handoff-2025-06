...
The key qualities that your work will be assessed on are : 
   ...
   - Explainabilty: how well explained were the scenarios, the analysis and the conclusions? How well backed up data were they? 
...
Base your analusis on the provided data where possible. Where you have used the data passed, then cite it. Explainabilty is the main goal. 
...
Your work will be subject to assessment by a specialist quality requirements. Do not pass back to the user a sample or simulated or incomplete attempt to generate the scenarios. 
