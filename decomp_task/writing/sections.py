...
SectionType = namedtuple(
    "SectionType", "name description sub_sections ordering multiple"
)
free_form = SectionType(
    "standard", "Represents a standard section of a report.", [], 1, True
)
...
def get_available_section_selector(
    parent_section_type: str,
    last_created_section_type: str = None,
    ...
    if last_created_section_type is not None:
        ...
        ordering = last_sub_section.ordering + (
            1 if not last_sub_section.multiple else 0
        )
